 ...
 *        (см. [com.omnix.server.cost.RequestCostEstimator]). Дефолт MEDIUM
...
data class ProviderRequirements(
    ...
    val costClass: com.omnix.server.cost.CostClass = com.omnix.server.cost.CostClass.MEDIUM
)
...
class DefaultProviderSelectionPolicy(
    ...
    private val overrides: com.omnix.server.admin.ProviderRuntimeOverrides =
        com.omnix.server.admin.ProviderRuntimeOverrides()
