...
import com.omnix.server.billing.BillingEventKind
...
import com.omnix.server.billing.VerifiedBillingEvent
...
import com.omnix.server.provider.TransportException
...
class BillingPersistenceIntegrationTest : PostgresTestSupport() {
    ...
    private inner class FakeProvider(private val delayMs: Long = 0) : BillingProvider {
        ...
        override suspend fun createCheckout(
            order: com.omnix.server.billing.BillingOrder,
            plan: BillingPlan
        ): ProviderCheckout {
