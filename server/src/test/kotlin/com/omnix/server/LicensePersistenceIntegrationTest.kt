...
class LicensePersistenceIntegrationTest : PostgresTestSupport() {
        ...
        return LicenseService(repository, crypto, clock).also {
            it.upsertPlan(
                BillingPlan(
                    ...
                    displayName = "OMNIX Clip Monthly",
                    durationDays = 30,
                    amountMinor = 1_400,
                    currency = "USD",
    ...
    fun `unknown malformed and foreign-device replays never redeem`() {
        ...
        assertTrue(
            service.redeem("OMX-AAAAA-AAAAA-AAAAA-AAAAA", "device-abcdefgh", "r2", null)
    ...
    @Test(expected = com.omnix.server.license.UnknownPlanException::class)
