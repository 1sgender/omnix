...
import com.omnix.server.provider.ProviderMessage
...
class ProviderContractTest {
    ...
    fun `groq success fixture parses text and usage tokens`() {
        ...
        assertTrue("expected Success, got $result", result is com.omnix.server.provider.ProviderResult.Success)
        result as com.omnix.server.provider.ProviderResult.Success
    ...
    fun `groq 429 fixture classifies as RATE_LIMITED`() {
        ...
        assertTrue(result is com.omnix.server.provider.ProviderResult.Failure)
        result as com.omnix.server.provider.ProviderResult.Failure
    ...
    fun `openrouter success fixture parses despite extra provider fields`() {
        ...
        assertTrue(result is com.omnix.server.provider.ProviderResult.Success)
        result as com.omnix.server.provider.ProviderResult.Success
