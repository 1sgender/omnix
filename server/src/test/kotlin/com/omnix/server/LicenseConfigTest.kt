...
class LicenseConfigTest {
    private fun baseEnv() = mutableMapOf(
        "DATABASE_URL" to "jdbc:postgresql://db.internal:5432/omnix",
        "DATABASE_USER" to "omnix",
        "DATABASE_PASSWORD" to "database-secret",
        "LICENSE_CODE_PEPPER" to "p".repeat(64),
        "BILLING_PLANS" to "earclip-monthly|omnix-clip|Monthly|30|1400|USD|pri_1234567890|USDT",
