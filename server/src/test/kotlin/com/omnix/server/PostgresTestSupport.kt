...
open class PostgresTestSupport {
    ...
    fun resetPostgres() {
        dataSource = DatabaseFactory.create(
            DatabaseConfig(
                jdbcUrl = System.getenv("OMNIX_TEST_DATABASE_URL")
                    ?: "jdbc:postgresql://127.0.0.1:15432/omnix_test",
                user = System.getenv("OMNIX_TEST_DATABASE_USER") ?: "user",
                password = System.getenv("OMNIX_TEST_DATABASE_PASSWORD") ?: "unused",
                maxPoolSize = 16
            )
        )
