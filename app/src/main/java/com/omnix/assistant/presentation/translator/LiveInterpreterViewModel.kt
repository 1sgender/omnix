...
import com.omnix.assistant.agent.translator.InterpreterMode
import com.omnix.assistant.agent.translator.InterpreterPreset
import com.omnix.assistant.agent.translator.LiveTranslatorEngine
import com.omnix.assistant.agent.translator.SupportedLanguage
import com.omnix.assistant.agent.translator.TranslationLanguageDetector
...
class LiveInterpreterViewModel @Inject constructor(
     ...
     * OmnixVoiceService на RINGING/OFFHOOK зовёт orchestrator.pauseForPhoneCall(),
    ...
    private fun dispatchParallelTranslation(text: String) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val item = TranslationItem(
                ...
                isTranslated = result is com.omnix.assistant.agent.translator.TranslationResult.Success,
