package com.omnix.assistant.core.clip
...
/**
 * HTTP-реализация над OMNIX API — паттерн HttpLicenseServerValidator:
 * bearer omx_-токен, ограниченное чтение ответа, короткие таймауты, без
...
class HttpClipAttestationApi(
    ...
    private companion object {
        ...
        val BASE_URL: String = AppConstants.OMNIX_LICENSE_BASE_URL
    }
