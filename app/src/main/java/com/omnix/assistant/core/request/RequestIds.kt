package com.omnix.assistant.core.request
 ...
 *    (`OmnixApiHandler`: клиентский id принимается только ≤ 64 символов).
 *
 ...
 * протаскивается через [com.omnix.assistant.agent.decision.ExecutionRequest.requestId]
 * → Router/Tool логи → `OmnixApiClient.execute` → сервер пишет его в
