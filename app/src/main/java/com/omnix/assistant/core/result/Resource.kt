package com.omnix.assistant.core.result
...
sealed interface Resource<out T> {
     ...
     *
     * Используется для privacy-consent gate: когда [com.omnix.assistant.agent.decision.ExecutionRequest]
    ...
    data class NeedsConsent(
        ...
        data class RetryArgs(
            ...
            val source: com.omnix.assistant.agent.decision.RequestSource,
            val privacyLevel: PrivacyLevel
        )
    }
}
