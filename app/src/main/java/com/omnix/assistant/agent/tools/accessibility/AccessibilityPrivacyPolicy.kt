 ...
 * "omnix_accessibility_privacy" (чтение должно быть синхронным из
 ...
 *                      явно разрешённое (+ собственный пакет OMNIX).
 ...
 *     приватный контент);
 *  3. собственный пакет OMNIX → всегда разрешён (иначе ассистент не может
