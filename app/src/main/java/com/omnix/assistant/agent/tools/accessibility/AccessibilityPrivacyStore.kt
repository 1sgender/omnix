 ...
 * пакетов в SharedPreferences "omnix_accessibility_privacy" — тот же файл,
 * который синхронно читает [OmnixAccessibilityService] (сервис вне Hilt-графа,
...
class AccessibilityPrivacyStore @Inject constructor(
    ...
    companion object {
        const val PREFS_NAME = "omnix_accessibility_privacy"
