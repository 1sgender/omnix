package com.omnix.assistant.agent.tools.verification
...
/**
 * Действие над громкостью — общее для [com.omnix.assistant.agent.tools.device.SetVolumeTool]
 * и [com.omnix.assistant.agent.tools.media.MediaControlTool].
 */
