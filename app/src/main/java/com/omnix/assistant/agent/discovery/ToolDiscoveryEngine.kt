package com.omnix.assistant.agent.discovery
...
class ToolDiscoveryEngine @Inject constructor(
    ...
    fun discoverTools(
        ...
        val scoredTools = mutableListOf<Pair<OmniTool, Float>>()
     ...
     */
    fun buildTargetedToolsPrompt(discoveredTools: List<OmniTool>): String {
