 ...
 * ([com.omnix.assistant.agent.memory.procedural.WorkflowExecutor]). Оба пути
 ...
 * [com.omnix.assistant.domain.repository.AIRepository] → `OmnixApiAiClient` →
 ...
 * [com.omnix.assistant.agent.planner.CognitivePlanner] и
 * [com.omnix.assistant.agent.engine.AgentCognitiveLoop].
 *
