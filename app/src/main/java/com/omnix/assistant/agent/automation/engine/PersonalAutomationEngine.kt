...
import com.omnix.assistant.agent.automation.model.AutomationTriggerType
    ...
    private suspend fun executeRules(rules: List<AutomationEntity>, nowMillis: Long) {
        ...
        for (rule in rules) {
            ...
            try {
                ...
                val results = toolExecutor.executeAll(calls, com.omnix.assistant.agent.policy.ActionOrigin.AUTOMATION)
