package com.omnix.assistant.agent.automation.scheduler
...
import com.omnix.assistant.agent.automation.engine.PersonalAutomationEngine
 ...
 *
 * Паттерн асинхронной работы скопирован 1-в-1 с [com.omnix.assistant.voice.service.SystemEventReceiver]:
...
class AutomationScheduleReceiver : BroadcastReceiver() {
    companion object {
        ...
        const val ACTION_TRIGGER = "com.omnix.assistant.action.AUTOMATION_SCHEDULE_TRIGGER"
        const val ACTION_RECONCILE = "com.omnix.assistant.action.AUTOMATION_SCHEDULE_RECONCILE"
