 ...
 *
 * Позволяет OMNIX взаимодействовать с экранными элементами, делать системные скриншоты,
...
class OmnixAccessibilityService : AccessibilityService() {
    ...
    companion object {
         ...
         */
        private fun privacyPolicy(service: OmnixAccessibilityService): AccessibilityPrivacyPolicy {
    ...
    override fun onServiceConnected() {
        ...
        instance = this
        Log.d(TAG, "OmnixAccessibilityService connected and active")
    }
    ...
    override fun onInterrupt() {
        Log.d(TAG, "OmnixAccessibilityService interrupted")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d(TAG, "OmnixAccessibilityService destroyed")
        instance = null
    }
}
