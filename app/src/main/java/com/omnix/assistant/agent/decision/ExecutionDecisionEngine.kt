...
class ExecutionDecisionEngine @Inject constructor(
    ...
    // =====================================================================
    // PRIORITY 1 — Device Tool через существующий ToolExecutor / OmniTool
    // =====================================================================
    ...
    private suspend fun executeSingleToolCall(
        request: ExecutionRequest,
        call: com.omnix.assistant.agent.model.ToolCall,
        confidence: Float
    ): ExecutionResult {
        ...
        return when {
            result.isSuccess -> ExecutionResult.Success(
                ...
                containsScreenContent = com.omnix.assistant.agent.tools.accessibility.ScreenContentPrivacy.isScreenReaderCall(call.toolId),
                metadata = mapOf(
