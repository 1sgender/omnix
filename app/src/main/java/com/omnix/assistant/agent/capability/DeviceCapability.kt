...
enum class DeviceCapability(val id: String, val description: String) {
    ...
    USE_ACCESSIBILITY_SERVICE("use_accessibility_service", "Включённая служба специальных возможностей OMNIX")
}
...
interface CapabilityChecker {
    ...
    /**
     * Статус группы Android Capability Layer ([OmniCapability]).
     ...
     */
    fun statusOf(capability: OmniCapability): CapabilityStatus
