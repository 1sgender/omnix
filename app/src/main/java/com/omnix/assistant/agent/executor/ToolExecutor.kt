...
import com.omnix.assistant.agent.policy.ActionOrigin
...
class ToolExecutor @Inject constructor(
     ...
     * [com.omnix.assistant.agent.core.OmniTool.executionTimeoutMs].
     ...
     * [com.omnix.assistant.agent.core.OmniTool.mapError] (единый error
    ...
    suspend fun executeAll(
        ...
        val executedHistory = mutableListOf<Pair<OmniTool, ToolExecutionResult>>()
     ...
     */
    private suspend fun performRollback(executedHistory: List<Pair<OmniTool, ToolExecutionResult>>) {
