package com.omnix.assistant.agent.memory.procedural
...
class WorkflowExecutorTest {
    ...
    fun setUp() {
        ...
        val tools = setOf<OmniTool>(
            DummyTool("device.volume"),
            DummyTool("device.flashlight"),
            DummyTool("device.open_app")
        )
        val registry = ToolRegistry(tools, com.omnix.assistant.agent.discovery.ToolDiscoveryEngine(com.omnix.assistant.agent.memory.semantic.SemanticTextMatcher()))
