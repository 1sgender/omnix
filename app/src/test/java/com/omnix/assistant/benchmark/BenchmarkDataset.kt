...
import com.omnix.assistant.benchmark.BenchmarkCategory.AGENT
import com.omnix.assistant.benchmark.BenchmarkCategory.AMBIGUOUS
import com.omnix.assistant.benchmark.BenchmarkCategory.CLOUD_AI
import com.omnix.assistant.benchmark.BenchmarkCategory.CLOUD_WEB
import com.omnix.assistant.benchmark.BenchmarkCategory.DEVICE
import com.omnix.assistant.benchmark.BenchmarkCategory.EDGE_CASE
import com.omnix.assistant.benchmark.BenchmarkCategory.LOCAL_AI
import com.omnix.assistant.benchmark.BenchmarkCategory.PRIVACY
import com.omnix.assistant.benchmark.ExpectedExecutionType as Exp

/**
 * OMNIX Benchmark Dataset v1 — 100 команд.
 *
...
object BenchmarkDataset {
    ...
    val cases: List<BenchmarkCase> = buildList {
        ...
        // ================================================================
        // DEVICE — 25. Управление устройством через ToolExecutor/OmniTool.
        // ================================================================
